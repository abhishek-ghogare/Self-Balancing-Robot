...
#include "anim_images/one.h"
#include "anim_images/two.h"
#include "anim_images/three.h"
#include "anim_images/four.h"
#include "anim_images/five.h"
#include "anim_images/six.h"
#include "anim_images/seven.h"
#include "anim_images/eight.h"
...
void glcd_cmd(unsigned char cmd) {
    ...
    GPIOPinWrite(GPIO_PORTE_BASE,
            GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3, 0x00);
    ...
    GPIOPinWrite(GPIO_PORTE_BASE,
            GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3, cmd);
    GPIOPinWrite(GPIO_PORTB_BASE,
            GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7, cmd);
...
void glcd_data(unsigned char data) {
    ...
    GPIOPinWrite(GPIO_PORTE_BASE,
            GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3, data);
    GPIOPinWrite(GPIO_PORTB_BASE,
            GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7, data);
...
int main() {
    // Time taken by task1 task2 task3
    uint64_t task1_min = UINT64_MAX;
    uint64_t task1_max = 0;
    uint64_t task2_min = UINT64_MAX;
    uint64_t task2_max = 0;
    uint64_t task3_min = UINT64_MAX;
    uint64_t task3_max = 0;
    ...
    while (1) {
        ...
        c_start = HWREG(DWT_BASE + DWT_O_CYCCNT) - c_start; // at the end of the code

        task1_max = c_start > task1_max ? c_start : task1_max;
        task1_min = c_start < task1_min ? c_start : task1_min;
        ...
        task2_max = c_start > task2_max ? c_start : task2_max;
        task2_min = c_start < task2_min ? c_start : task2_min;
        ...
        task3_max = c_start > task3_max ? c_start : task3_max;
        task3_min = c_start < task3_min ? c_start : task3_min;
    }
